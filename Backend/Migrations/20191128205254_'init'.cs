        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Devices_Attempts_AttemptId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttemptDevices", x => new { x.AttemptId, x.DeviceMacAddress });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttemptDevices_Devices_DeviceMacAddress",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameSequences_Devices_DeviceMacAddress",
                        column: x => x.DeviceMacAddress,
                        principalTable: "Devices",
                        principalColumn: "MacAddress",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_AttemptId",
                table: "Devices",
                column: "AttemptId");

            migrationBuilder.CreateIndex(
                name: "IX_GameSequences_DeviceMacAddress",
                table: "GameSequences",
                column: "DeviceMacAddress");
        }
